...
export class Page {
    ...
    public LeaderSnapshotOneToOnes(companyId: string, leaderSnapshot: LeaderSnapshot, prevIndex: number, nextIndex: number): string {
        ...
        tableAB.push(new SvgElement(true).add(
            new SvgButton("Prev", menuButtonWidth, this._configuration.lineHeight, this._configuration.fontSize, "784ABA", Pages.LeaderSnapshotOneToOnes, prevActionParams),
            ...
            new SvgButton("Next", menuButtonWidth, this._configuration.lineHeight, this._configuration.fontSize, "784ABA", Pages.LeaderSnapshotOneToOnes, nextActionParams)));
